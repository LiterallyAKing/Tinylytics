...
Mostly only useful for mobile free-to-play and online "games as service!"
lock up raw data on platform providers' servers; if you even can get access it costs extra
are often gathering all that data so they can resell it in bulk or use it for advertising!

Tinylytics, on the other hand:
can record anything a player or game does, as long as you tell it what to watch for! 

It's data for gameplay, not just business & money!
hands over all the data directly to you, the developer, no strings attached!
